...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> employeeException(EmployeeException e,WebRequest r){
		MyErrorDetails err=new MyErrorDetails(LocalDateTime.now(), e.getMessage(), r.getDescription(false));
		return new ResponseEntity<>(err,HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(DepartmentException.class)
	public ResponseEntity<MyErrorDetails> departmentException(DepartmentException e,WebRequest r){
		MyErrorDetails err=new MyErrorDetails(LocalDateTime.now(), e.getMessage(), r.getDescription(false));
		return new ResponseEntity<>(err,HttpStatus.BAD_REQUEST);
	}
